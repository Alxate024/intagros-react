...
import imagenLogistica from '/media/logistica.png?url';

export const localImages = {
  asesorias: imagenAsesorias,
  ambiental: imagenAmbiental,
  tecnologia: imagenTecnologia,
  logistica: imagenLogistica,
};
