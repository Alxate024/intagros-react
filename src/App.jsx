...
const ContactPage = lazy(() => import('./pages/InstitutionalPage').then((module) => ({ default: module.ContactPage })))
const CropsPage = lazy(() => import('./pages/InstitutionalPage').then((module) => ({ default: module.CropsPage })))
